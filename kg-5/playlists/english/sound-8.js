    ...
    list: [
        {
            ...
            data: {
              ...
              audioOffset: 0,
              text: 'camera, headphone, pendrive, remote, smartphone, speaker, tablet, torch, webcam'
            }
          }, 
        {
        type: 'slides',
      ...
      },
      {
        ...
        data: {
          ...
          title: 'Listening Activity',
          audioOffset: 42,
          text: 'daffodil, gulmohar, lily, pansy, poppy, daisy, jasmine, magnolia, periwinkle, water-lily'
        }
      },
      {
        type: 'rightOne',
