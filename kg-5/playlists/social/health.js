    ...
    list: [
        ...
        data: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: 'playing video games for long hours, reading with proper light,  washing with clean and cold water'
            },
            {
            ...
            },
            {
                ...
                options: '*listening to music at high volumes, *using sharp objects to clean ears, avoiding loud noises'
            }
          ]
        }
      },
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: ' Which of the following is not the right way to treat a differently-abled person?',
              options: 'call them names, speak slowly and clearly to them, ask them if they need help, treat them as normal people'
            },
            {
              qText:
                'If you see a blind person trying to cross the road what can you do to help them?',
              options: 'help them cross the road, ignore and walk past them, tease them'
            },
            {
              qText: 'You see a differently-abled person trying to get into the bus. What can you do?',
              options: '*ask them if they need help, *make way for them, *help them get into the bus, walk past them'
            }
          ]
        }
      },
