export default {
    ...
    list: [
      {
        label: 'Changes in Family and Neighborhood',
        type: 'passage',
        id: 'changes',
        data: {
          title: 'Changes in Family and Neighborhood',
          text: `# Changes in Family
...
Friendly and harmonious relations make for joyful *community life*.`
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: ' What causes changes in the number of people in the family?',
              options: '*marriage, *birth, *death, *migration'
            },
            {
              qText: 'What is the process of moving from one place to another to live called?',
              options: 'migration, immigration, emigration'
            },
            {
              qText: 'As we migrate what can we see in our country?',
              options: 'diversity, disparity, conflicts'
            }
          ]
        }
      },
      {
        label: 'My Delightful School',
        type: 'passage',
        id: 'school',
        data: {
          title: 'My Delightful School',
          text: `# My Delightful School
...
When we offer and seek help, learning becomes more *enjoyable*.`
      ...
      {
        label: 'Responsible and Sensitive',
        type: 'passage',
        id: 'responsible-sensitive',
        data: {
          title: 'I’ll be responsible and sensitive',
          text: `# Caring for the elderly 
...
*Sharath Gayakwad* is disabled in one hand. However, he has made the country famous worldwide in swimming competitions.`
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'If someone at home or in the neighborhood is suffering from an illness, what is the right thing to do?',
          types: [
            {
              name: 'Right',
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText:'What helps blind people to walk in a street?',
              options: 'cane, braille, wheelchair'
            },
            {
              qText: 'What is the special script used by blind people to read called?',
              options:'Braille, sign language, Hindi '
            },
            {
              qText: 'What is the special language used by people who can not hear properly?',
              options: 'sign language, braille, English'
            },
            {
              qText: 'What is the concrete slope next to stairs in some buildings called?',
              options: 'ramp, slope, slide'
            },
            {
                qText: 'What is the use of the ramp?',
                options: 'helps people in a wheelchair to enter the building, used by kids as a slide, it is useless'
            }
          ]
        }
      },
      {
        label: 'Management of Community Life',
        type: 'passage',
        id: 'management-community',
        data: {
          title: 'Management of Community Life',
          text: `# What is management?
