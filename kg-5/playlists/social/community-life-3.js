    ...
    list: [
      {
        ...
        id: 'public-services',
        data: {
          title: 'Public Services for Community Life',
          text: `# Community Life
...
# Local Government 
We live in cities or villages. The population of cities is large whereas, in villages, it is quite small. In cities, there are factories, markets and greater chances for employment. Cities have public services on a large scale. The administration of a place, be it a city or a village, is run by the government in that place. It is known as local government.
A gram panchayat runs the administration of a village.
A municipality runs the administration of a town and for big cities, there is a municipal corporation.
# Public Services
...
The people in a locality sometimes come together and find out what the local needs are. Based on their findings, they decide to start an industry or service in co-operation with one other. They contribute some of their own money to start that industry or service. The profits are distributed among everyone. Institutions formed by people’s cooperation are called co-operatives.`
      ...
      },
      {
        ...
        data: {
          ...
          text: `Public facilities are services that are available for *everybody (elite group)*.
...
Institutions formed by the cooperation of the people are called *co-operatives.*`
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: ' What are public services?',
              options: 'services available for everybody, services available for an elite group, service available to middle class'
            },
            {
              qText: 'Which services does the local government provide?',
              options: 'water supply and public hygiene, food, shelter'
            },
            {
              qText: 'Who keeps our money safe?',
              options: 'bank, municipality, panchayat'
            },
            {
              qText:'What are the institutions formed by peoples cooperation called?',
              options: 'cooperatives, municipal cooperation, local government'
            }
          ]
        }
      },
...
The members of the *town panchayats* are elected in the same way as village panchayats.`
      ...
      },
      {
        ...
        data: {
          ...
          text: `Kudavolai, old system of election 
...
Gram Sabha, development of plan`
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: ' Which level of government is a Panchayat?',
              options: 'village, state, district'
            },
            {
              qText: 'Who introduced the word Gram Swaraj?',
              options: 'Mahatma Gandhi, Nehru, Kamarajar '
            },
            {
              qText: 'What is the lower level of the three-tier system?',
              options: 'village, district, block-level'
            },
            {
              qText:'Who elects the vice president of the Panchayat?',
              options: 'ward member, district collector, people'
            },
            {
              qText: 'How long is the tenure of panchayat members?',
      ...
      },
      {
        ...
        data: {
          ...
          text: `# District Collector
The district collector is the Administrative head of a district. District Collector is responsible for the proper and smooth functioning of the district. I.A.S. officers are recruited by U.P.S.C (Union Public Service Commission). Some I.A.S. officers are appointed as district collectors. District Collector is the head of the revenue department.  District collector seeks assistance from the police force to maintain law and order in the district. The Superintendent of Police follows the order of the district collector. They inform district collectors from time to time about the law and order of the district. The district collector also supervises local bodies like the district board, village panchayat and municipal committees. Prompt actions during a natural disaster are taken by the district collector. The district collector has a major role in the development of the government. District collector makes sure that the policies should reach the people.
# District Administration System
More subordinates in district administration assist the district collector like the District Medical officer, Superintendent of Police, District Forest Officer, Chief Educational Officer, Revenue Divisional Officer (RDO) and other Officers. These heads take care of their departments. They all are a part of the district administration system. However, the district collector is responsible for the proper working of all departments to make sure that people are benefited by the government.         
# Health Officer
          ...
          questions: [
            {
              ...
              options: 'District collector, Judge, Superintendent of Police'
            },
            {
              qText: 'What does the police department maintain?',
              options:'Law and order, Health, Forest '
            },
            {
              qText: 'Who ensures the proper functioning of the educational department in a district?',
              options: 'Chief Educational Officer, Forest Officer, Police Officer'
            },
            {
              qText: 'Who advises on the sanitation of the district?',
              options: 'Health Officer, Forest Officer, Revenue Officer'
            }
          ]
        }
      }
