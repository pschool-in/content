...
The Constitution of Independent India abolished *untouchability (sati)* .`
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'Classify the actions based on whether they are honest or dishonest.',
          types: [
            {
              name: 'Honest',
          ...
          questions: [
            {
              ...
              options: 'Take him to the nearby police station, Leave him with a stranger, Do not pay attention to the crying boy'
            },
            {
              qText: 'While on a trip, you realize that our friend has forgotten her tiffin at home. What will you do?',
              options: 'Share your tiffin with her, Let her starve, Ask her to go back by herself.'
            },
            {
              qText: 'Your teacher is punishing your friend for a mistake that you committed. What will you do?',
              options: 'Accept your mistake, Let your friend get punished, Blame it on someone you don’t like.'
            },
            {
              qText: 'Your friend tripped and fell while you were playing. What will you do?',
              options: 'Help her get up, Laugh at her, Keep playing and don’t pay attention to her'
            }
          ]
        }
      }
