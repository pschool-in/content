...
# Child Labour
Children are sometimes involved in different works at different places. This is called Child Labour. It is illegal to force children below the age of 14 to work. If we see any children forced to work around us then we should call the Childline number 1098 [Ten Nine Eight] and inform. You can call at any time and it is free of cost. If you see child labor, talk to him/ her first. If they are forced to do the job, you can call the number and inform them. They will come and help the child.
# Right to Protection
Children have the right to be protected in all circumstances. The Indian government has set laws for the same. There are laws to punish people who touch children inappropriately. All you need to do is, keep an eye out for danger and be confident. There is another rule, no person should hit or harm children. It is wrong to hit children, as it affects their well-being. Elders should help to create a safe environment for children to live in.
# Right to Participate
Children have the right to participate in matters related to them. This includes asking questions, giving suggestions and making decisions in things that affect them. Children have the right to participate in discussions and implementation of all things related to them.`
      }
    },
    {
      id: 'fillup',
    ...
    },
    {
      ...
      data: {
        questions: [
          ...
          {
            qText: 'Who is given polio drops?',
