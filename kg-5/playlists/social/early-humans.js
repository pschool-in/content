  ...
  list: [
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: '________ are the first pet animals.',
            options: 'Dogs, Horses, Cows'
          },
          {
            qText: 'In Old Stone Age period, humans lived in _______.',
            options: 'caves, tents, huts'
          },
          {
            qText: '_______ is considered as the first scientific invention.',
            options: 'wheel, fire, stone, metal'
          },
          {
            qText:
              'Early humans wandered from one place to another. It is called _______ life.',
            options: 'nomadic, stone age, pre historic'
          },
          {
            qText: 'The first wheel was made up of ______.',
            options: 'stone, clay,  wood, metal'
          },
          {
            qText:
              'After learning agriculture, humans settled near the ________.',
            options: 'rivers, lakes, mountains, forests'
          },
          {
            qText: 'The baked ____ was strong and looked beautiful.',
            options: 'pot, stone, wheel, meat'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'The first metal discovered was __________.',
            options: 'Copper, Iron, Bronze'
          },
          {
            qText: 'Which metal is not used in making Bronze?',
            options: 'Iron, Copper, Tin, Zinc'
          },
          {
            qText: 'Which of the following is not considered as an artefact?',
            options: 'old trees, coins, potsherds, metal objects'
          },
          {
            qText:
              '_________ is the process of digging ground and discovering artefacts.',
            options: 'Excavation, Numismatics, Pottery, Archaeology'
          },
          {
            qText: 'Where should we go to see the artefacts?',
            options: 'Museum, Zoo, Theme Park, Archaeological Sites'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      type: 'sorting',
      data: {
        title: 'Order the things used by Humans from old to new.',
        text: 'Stone, Fire, Pot, Copper, Bronze, Iron, Electricity, Computer'
      },
      id: 'sort'
    }
  ]
