export default {
    ...
    list: [
      ...
      },
      {
        ...
        type: 'group',
        data: {
          title: 'Classify the below things based on where they belong in the environment',
          types: [
            {
              name: 'Lithosphere',
    ...
    },
    {
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: 'Water on the earth ___________ continuously due to the heat of the sun.',
              options: 'evaporates, condensate, cycles'
            },
            {
                qText: 'A biosphere contains _______________ .',
                options: 'Plants, Animals, Humans, Microorganisms'
              },
              {
                qText: 'The envelope of air around the earth is called the _______________ ',
              ...
              {
                qText: 'The layer that extends from the earth’s surface to a height of about 13 km is called the ___________. ',
    ...
    },
    {
      ...
      },
      {
        ...
        data: {
          ...
          `Reduce: make/ use less material. Reuse: using the same thing again. Recycle: make new things out of scarp. It also helps in conservation of resources.`,
          
          `# Waste Separation`,
          
          `Biodegradable: left over food, vegetable waste etc. Recycleable: paper waste, glass waste, aluminum waste etc. Non-recycleable: plastic wrap, wax boxes etc.`,
        ...
        data: {
          ...
          types: [
            ...
            },
            {
              ...
              text: 'Glass, Metal, Electronic devices, Plastics, Batteries, Computer parts'
            }
          ]
        }
      },
      {
        ...
        data: {
          ...
          types: [
            {
              name: 'Blue waste',
              text:'newspapers, magazines, glass, cardboard, food tins, tetra packs'
            },
            {
              name: 'Red waste',
        ...
        data: {
          ...
          questions: [
            ...
            },
            {
              ...
              {
                qText: 'Plastic plates stay in the environment for over _______ years.',
                options: '1000, 100, 2000'
              },
              {
                qText: 'Glass containers for food and beverages are ________ recyclable.',
                options: '100%, 90%, 80%'
              },
              {
                qText: 'Moving the waste from one place to another is called _________.',
    ...
    },
    {
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'Classify the below sentences as Good and Bad',
          types: [
            {
              name: 'Good',
