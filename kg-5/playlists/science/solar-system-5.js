...
*Mangalyaan* was launched on 5 November 2013.`
    ...
    },
    {
      ...
      data: {
        ...
        text: `You can see me from the earth but the lighted part of me that you see changes every day. Who am I? - *Moon*
I have my own light. It is only from me that the planets get light and heat. Who am I? - *Sun*
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          ...
          {
            qText: 'What are the two parts of the earth made by the equator?',
            options:
    ...
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'True',
            text: `The moon completes one revolution around the earth in 28 days.
The moon gets very hot during the day and very cold at night.`
          },
          {
            name: 'False',
            text: `There is water on moon.
...
Edwin Aldrin was the first to set foot on the moon.`
    ...
    },
    {
      ...
      data: {
        ...
        text: `When the shadow cast by one celestial body falls on another celestial body it is called *eclipse*.
