    ...
    },
    {
        ...
        data: {
          ...
          questions: [
            ...
            {
                qText: 'As we go farther from the earth, the layers of air become ________.',
    ...
    },
    {
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: ' _________ radiation harms wildlife, damages plants and causes skin cancer in humans.',
              options: 'UV, IR, X ray'
            },
            {
              ...
              {
                qText: 'We can speak and hear the sound only when there is ____ around.',
              ...
              {
                qText: 'While ________ using firewood, fanning air helps in burning of fire wood.',
                options: 'Cooking, heating, burning'
              },
              {
                qText: '_________ used to fill up food packages to extend their shelf life.',
                options: 'Nitrogen, oxygen, carbon dioxide'
              },
              {
                qText: '__________ cylinders are used in hospitals to enable the patients to breathe when they cannot breathe normally.',
                options: 'Oxygen, nitrogen, carbon dioxide'
              },
              {
              ...
              {
                qText: 'The Scottish chemist Joseph Black discovered that ___________- is present in air.',
                options: 'Carbon dioxide, oxygen, nitrogen'
              },
              {
