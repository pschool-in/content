    ...
    list: [
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            {
              qText: 'Second highest layer of Earth’s atmosphere is ____________.',
            ...
            {
                qText: '___________ is the recreational and competitive adventure sport of flying.',
                options: 'paragliding, surfing, hand gliding '
            },
            {
                qText: 'Process of nitrogen fixation by ________ is called nitrogen fixation.',
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'Classify the below sentences as cause and effect of air pollution',
          types: [
            {
              name: 'Cause',
              text: `Industries
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            ...
            {
              qText: 'The Indian Standard Meridian passes through the city of ___________.',
            ...
            },
            {
              ...
              options: 'Nimbus clouds, Cirrus cloud,  Stratus clouds, Cumulus clouds '
            }
          ]
        }
      }
