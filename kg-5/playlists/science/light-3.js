    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          ...
          {
            qText:
              'When does the length of the shadow formed by the sun is the shortest?',
...
In the evening, shadows are *long*.`,
        ...
        `The *sun* is an example for luminous object.
A *table* is an example for a non-luminous object.
A wall is an example for *opaque* object.
Clean water is an example for *transparent* object.
...
Dark patch formed when an object blocks the path of the light is called *shadow*.
Objects that doesn't allow light to pass through them are called *opaque* objects.`
      ]
    },
    {
      id: 'true-false',
...
The moon is a luminous object.`
        ...
        [
          `We cannot see things around us in dark.
