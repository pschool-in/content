export default {
    ...
    list: [
      ...
      },
      {
        ...
        type: 'group',
        data: {
          title: 'Classify the given items as modern or traditional means of communication.',
          types: [
            {
              name: 'Modern',
              text: 'e-mail, fax, television, mobile phones, pager'
            },
            {
              name: 'Traditional',
      ...
      },
      {
        ...
        data: {
          ...
          text: `The exchange of information over significant distances by electronic means. - *telecommunication*
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            ...
            {
              qText: 'Which organs are affected by excessive use of computers, television or phones? ',
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'Classify the activities as an advantage or disadvantage of mass media.',
          types: [
            {
              name: 'Advantage',
