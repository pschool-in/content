    ...
    list: [
        {
          ...
          },
          {
            ...
            type: 'group',
            data: {
              title: 'Classify the below animals on the basis of their domestic nature',
              types: [
                {
                  name: 'Domestic',
          ...
          },
          {
            ...
            data: {
              ...
              text: `Weaverbird uses *thorny* trees to build their nest.
              ...
              questions: [
                {
                  ...
                  options: 'Protect their eggs from other animals, Protect young birds as they are too weak to defend themselves, Have a safe place for laying their eggs, * All'
                },
                {
                  ...
                  },
                  {
                    ...
                    options: 'Store wild animals, Protect from the scorching sun, Avoid heavy rains, Be away from gusty winds'
                  },
                  {
        ...
        },
        {
          ...
          },
          {
            ...
            type: 'group',
            data: {
              title: 'Classify the below animals on the basis of whether they lay eggs or not',
              types: [
                {
                  name: 'Lay eggs',
          ...
          },
          {
            ...
            data: {
              ...
              questions: [
                {
                  qText: ' Which one of the following is not the stage of butterfly growth?',
                  options: 'None of the options, Egg, Larva, Pupa, Adult'
                },
                {
                    qText: 'Where does Plain Tiger Butterfly lay her egg?',
                    options: 'Milkweed (Rui) leaf, Mulberry leaf, Mango leaf, Maple leaf'                     
                  },
                  {
                  ...
                  },
                  {
                    ...
                    options: 'Metamorphosis, Photosynthesis, Metagenesis, Crystallization'
                  },
                  {
        ...
        },
        {
          ...
          },
          {
            ...
            type: 'group',
            data: {
              title: 'Classify the below animals on whether they live on land or water.',
              types: [
                {
                  name: 'Terrestrial',
                ...
                {
                  name: 'Aquatic',
                  text: 'Fish, Tortoise, Octopus, Seahorse, Jellyfish, Starfish, Mussel'
          ...
          },
          {
            ...
            type: 'group',
            data: {
              title: 'Classify the below animals on the basis of their eating habits.',
              types: [
                {
                  name: 'Herbivore',
...

          {
            ...
            data: {
              ...
              questions: [
                ...
                {
                    qText: 'The butterfly has a tube like structure called _________ to suck nectar from flowers.',
                    options: 'proboscis, Canines, Incisors, None of the above'                     
                  },
                  {
                    qText: 'A __________ usually starts with plants and ends with carnivores or omnivores.',
        ...
        },
        {
          ...
          },
          {
            ...
            type: 'group',
            data: {
              title: 'Classify the below animals on whether they live alone or in groups.',
              types: [
                {
                  name: 'Alone',
          ...
          },
          {
            ...
            type: 'group',
            data: {
              title: 'Classify the below animals on the basis of their nocturnal behaviour..',
              types: [
                {
                  name: 'Nocturnal',
            ...
            data: {
              ...
              questions: [
                ...
                },
                {
                  ...
                  {
                    qText: 'The changes in an animal behaviour to adjust with its habitat is called _________.',
                  ...
                  {
                    qText: 'Bats use ultrasonic sounds to find their way in dark and detect objects. This is called ____.',
        ...
        },
        {
          ...
          },
          {
            ...
            data: [
                `PRIDE , THORAX , DIURNAL , FLOCK , TRUNK`,
          ...
          {
            id: '4100',
            label: 'Some facts on Animal  - Match the following',
            type: 'match',
            data: {
              text: `Zygote, Fertilised egg
              Viviparous, Cat
          ...
          },
          {
            ...
            data: {
              ...
              questions: [
                {
                  qText: ' Which of the following location has Viralimalai Bird Sanctury?',
                  options: 'Trichi, Mumbai, Patna, Dehradun'
                },
                {
                    qText: 'Which of the following is not associated with asexual reproduction?',
