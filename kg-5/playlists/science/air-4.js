...
xenon, oxygen, nitrogen, carbon dioxide`
    ...
    },
    {
      ...
      id: 'drag-drop-3',
      data: {
        text: `Burning of fossil fuels release smoke, which may lead to ___________.| AIR POLLUTION| A__ P___U__O_
Layer of atmosphere that protects us from UV rays is called __________.| OZONE| _Z_N_
...
Liquid or solid particles are dispersed in air are called __________.|AEROSOSL| A_R_S_L
Hydrocarbons such as the Chloro Fluoro Carbons (CFCs) destroy the _______ layer.|OZONE| O_O___`
      }
    },
    {
      id: 'match-4',
