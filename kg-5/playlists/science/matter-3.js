...
Gas does not have fixed shape and volume. eg: cloud, smoke, gas cylinder (LPG), spray, water vapour, wind.`
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Volume is the ______ occupied by an object.',
          ...
          {
            qText: 'Which of the following has volume but does not have shape?',
            options: `liquid, solid, gas`
          },
          {
            qText: 'Which of the following does not have volume and shape?',
            options: `gas, liquid, solid`
          },
          {
            qText:
              'The amount of matter present in an object is measured by _______.',
            options: `mass, volume, space, state of matter`
          }
        ]
      }
    },
    {
      ...
      type: 'group',
      data: {
        title: 'Classify the below as liquid and gas.',
        types: [
          {
            name: 'Liquid',
            text: 'honey, water, juice, oil'
          },
          {
            name: 'Gas',
...
*Gas* has no fixed shape and no fixed volume.`
    ...
    {
      id: 'notes-2',
      label: 'Change in States of Matter',
      type: 'passage',
      data: {
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          ...
          {
            qText: 'Change of gas into liquid on cooling is called ______.',
            options: `condensation, freezing, evaporation`
          },
          {
          ...
          },
          {
            ...
            options: `freezing, evaporation, melting`
          }
        ]
      }
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'True',
            text: `Change of liquid to gas is called evaporation.
...
Electrical energy is also used as fuel for cooking and transporting.`
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Gas has ______.',
            options: `mass, shape, volume`
          },
          {
            qText: '_____ is used for heating and preparing food.',
            options: `Fuel,  Paper, Gas`
          },
          {
            qText: '_______ energy is also used as fuel.',
            options: `Electrical, Magnetic, Glucose`
          },
          {
            qText: '______ is the common fuel used in cars.',
            options: `Petrol, Charcoal, Firewood, LPG`
          },
          {
            qText: '______ is the common fuel used in cooking.',
    ...
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'True',
            text: `Domestic gas (LPG) helps in cooking.
