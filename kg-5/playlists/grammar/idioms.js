...
`
        ...
        questions: [
          {
            ...
            options: 'an event that happens infrequently, an event that happens regularly, an event that happens frequently'
          },
          {
          ...
          },
          {
            ...
            options: 'To start the process all over again, to complete the process, to hold the process in the middle '
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            options: 'Not speaking directly about the issue, speaking directly about the issue, not speaking at all'
          },
          {
            qText: 'Hit the hay',
          ...
          },
          {
            ...
            options: 'to share the secret, to hide the secret, to conceal the secret'
          },
          {
            qText:
              'Cross your fingers',
            options: 'to hope something happens your way, to hope something doesnt happen, to hope something happens the way your friends wanted'
          },
          {
            qText:
              'Hit the books',
    ...
    },
    {
          ...
          questions: [
            {
              ...
              options: 'to make someone laugh, to make someone cry, to make someone eat'
            },
            {
              qText: 'Out of the blue',
              options: 'Something that occurs unexpectedly, something that occurs frequently, something that occurs very regularly'
            },
            {
            ...
            },
            {
              qText:
                'Know the ropes',
              options: 'to understand the details, to miss the details, to write the details'
            },
            {
              qText:
                'Chicken out',
              options: 'to avoid doing something due to fear, to be brave, to be strong'
            }
          ]
        }
      },
        ...
        data: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: 'difficult to understand, easy to understand, clear to understand'
            },
            {
              qText:
                'In a nutshell',
          ...
          questions: [
            {
              ...
              options: 'from a rich family, from a poor family, from a middle-class family'
            },
            {
              qText: 'Pitch black',
            ...
            },
            {
              ...
              options: 'to have fun, to paint the town with red color, to work hard'
            },
            {
              qText:
                'Feel blue',
            ...
            },
            {
              qText:
                'Green thumb',
              options: 'talent for gardening, talent for singing, talent for dancing'
            }
          ]
        }
      },
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'Fill up the blanks in the sentence with appropriate expression.',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
...
5. Still water runs deep.`
      ...
      },
      {
        ...
        },
        {
            ...
            commonData: {
              isPractice: false,
              title: 'Drag and drop the words at correct places to make a complete proverb',
              styles: {
                fontSize: '1rem',
                dashWidth: 80
              }
