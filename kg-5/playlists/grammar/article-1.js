export default {
    ...
    list: [
      {
        label: 'Articles-Introduction',
        type: 'passage',
        id: 'article-1-reading',
        data: {
          title: 'Articles-Introduction',
          text: `The words that help define the naming words (nouns) as specific and non-specific are called as articles. The choice between a and an is determined by sound. These are called as indefinite articles because it leaves the person or the thing spoken of unclear. For example a doctor, that means any doctor.
