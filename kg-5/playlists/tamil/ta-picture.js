...
radish| முள்ளங்கி| _ள்ளங்கி| மு, ம, ஓ, ஔ
...
turmeric| மஞ்சள்| _ஞ்சள்| ம, மு, மெ, மி`
    ...
    },
    {
      ...
      data: {
        ...
        lang: 'ta',
        title: 'விடுபட்ட எழுத்தை தேர்வு செய்க',
        text: `rose| ரோஜா | _ஜா|ரோ, சே, பா, மா
...
jasmine| முல்லை| _ல்லை|மு, ம, மா, மே`
    ...
    },
    {
      ...
      data: {
        ...
        lang: 'ta',
        title: 'விடுபட்ட எழுத்தை தேர்வு செய்க',
        text: `bus| பேருந்து | _ருந்து | பே, பா, மா, மெ 
...
train| தொடர்வண்டி| _டர்வண்டி| தொ, தோ, து , தூ`
    ...
    {
      type: 'completeWord',
      label: 'நிரப்புக: தொழில்',
      id: 'jobs1',
      data: {
        images: 'custom',
        lang: 'ta',
        title: 'விடுபட்ட எழுத்தை தேர்வு செய்க',
        text: `postman| தபால்காரர்| _பால்காரர்| த, தி, தீ, து
...
police| காவலர் |_வலர் | கா, கொ, கி, கீ
...
flower-pot| பூந்தொட்டி | _ந்தொட்டி| பூ, ப, பா, பு
...
dustbin| குப்பை தொட்டி| _ப்பை தொட்டி| கு, கூ, க, கை`
    ...
    {
      type: 'completeWord',
      label: 'நிரப்புக: உணவுப்பொருட்கள்',
      id: 'snacks1',
      data: {
        images: 'custom',
        lang: 'ta',
        title: 'விடுபட்ட எழுத்தை தேர்வு செய்க',
        text: `chocolate| மிட்டாய்| _ட்டாய்| மி, மே, மீ, மு
