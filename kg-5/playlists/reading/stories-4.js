  ...
  list: [
    {
      ...
      data: {
        ...
        text: `Long, long ago, there lived three friends in a jungle. They were a deer, a crow, and a mouse. They used to share their meals.
...
Ravi asked his son to go along with the merchant. Then, the merchant, instead of taking Ravi's son to the temple, took him to a nearby hill and tied him with a big rock, and came back home.
...
"What nonsense!" shouted Ravi. "How can a vulture carry off a young boy?" But the merchant repeatedly claimed that a vulture carried away Ravi's son. The argument reached such a point that they began quarreling with each other, using dirty words.
...
Confused king, redirected the case to Birbal.`
    ...
    },
    {
      ...
      data: {
        title: 'Stone Soup',
        text: `Some travelers came to a village, carrying nothing more than an empty cooking pot. Upon their arrival, the villagers were not willing to share any of their food with the hungry travelers. Then, the travelers went to a stream and filled the pot with water, dropped a large stone in it, and placed it over a fire.
...
The villager handed them a little bit of seasoning. More and more villagers walked by, each adding another ingredient. Finally, the stone (being inedible) was removed from the pot, and a delicious and nourishing pot of soup was enjoyed by the travelers and villagers alike.
...
When the man on the tree had tied the rope tightly around his waist, Mulla pulled the rope with all his force. As soon as Mulla did this, the man fell from the tree and hurt himself badly. The bystanders were shocked at this. They turned to Mulla and asked, “What did you do? What a silly plan you had?”
