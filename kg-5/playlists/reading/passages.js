export default {
  ...
  list: [
    ...
    },
    {
      ...
      data: {
        title: 'Flowers',
        text: `The world will not be a beautiful place if it is without flowers. Flowers with their varied colors and perfume tell human beings that life is here to live and enjoy life as it is. Flowers have the power to make even a shabby place look like a place worth living in.  A flower can bring along cleanliness, beauty, and peace of mind to the place.
          According to Wikipedia, a flower is a reproductive structure found in flowering plants. The four main parts of a flower are the calyx, corolla, stamen, and pistil. The parts of a flower are arranged in a circular pattern called a whorl.  The calyx is the outer whorl of sepals. The calyx is green in color and in some plants, it looks like a petal. As a collective unit, the sepals form a calyx, and the petals form the Corolla. 
          ...
          Jasmine is also considered a symbol of love. Orchids are symbols of perfection, and sunflowers are considered as a symbol of infatuation. In Hindu mythology, Lotus is considered a symbol of fertility, purity, and creation. `
      }
    },
    {
      id: '500',
      ...
      data: {
        ...
        text: `Pranny ran to the school bus with a hop. Her friends greeted her with a loud cheer.  One by one they got into the bus. Luckily Pranny got the window seat.  Pranny always liked to sit near the window. She loved to count the number of trees that crossed their bus. Pranny started to count the number of trees when their bus entered the main road.  Pranny had finished counting one hundred when they reached their picnic spot. Pranny and her friends jumped down from the bus and entered the park with a scream that can bring down the buildings. Luckily, there were no buildings and the wide sky echoed back their scream. Pranny's teacher asked them to form a line and walk in pairs. Holding the hand of the partner, everyone started to climb up the path on the hill. 
    ...
    },
    {
      ...
      data: {
        ...
        text: `The cool rays of moon peeped in through the gap between the thin strips of coconut leaves. Standing on the terrace, Mini stood watching the moving clouds in the sky.  Gracefully the clouds sailed through the sky.  Gazing continuously at the full moon made her feel calm at heart and it also helped her nerves to settle down with a rhythm. Suddenly a ray of light started to descend from the sky. The thin ray of light slowly got dispersed and touched the top of a coconut tree.  The coconut leaves slowly moved in the evening breeze and sent the light in every direction. The pale-colored light rays slowly deepened to illuminating green light.  The green light which struck the coconut tree started to move toward Mini.
          ...
          Millie, the alien, looked at Mini.  The eyes without any eyebrows looked at her. It sent a vibration throughout her body. Mini felt hot and cold at the same time, and a strange feeling went down her spine. While Mini struggled with such a sensation, a chilled spray of water splashed at her face and dribbled down her chin.  Mini suddenly came to her senses. The overflowing water from the water tank has helped her to come out of the trance and break the magic spell from the alien. Within seconds the green light started to ascend toward the sky and disappeared from her sight. Mini slowly tried to recollect what happened to her. But, she could not do so. Her memory cells wiped clean of whatever has happened a few minutes ago made her look blank at the wide blue sky. `
      }
    },
    {
      id: '800',
      ...
      data: {
        ...
        text: `‘Joe, come and have your breakfast.’ Mary called her nine year old son.
          ...
          ‘Ma, bye, bye.’ Joe started to walk toward the door. The little ant shocked at the sudden jerk, held tightly to the threads of the socks. The bread crumbs fell on the floor, but Neemoo, the little ant could not climb down the shoe. Breathless, it stayed at the top of the shoe.
          When Joe climbed into the bus, Neemoo lost the grip and fell on the last step of the bus. The door of the bus closed and started moving toward the school where Joe studied. Neemoo stretched his feelers to know where he is. Neemoo heard the shrilling scream of little boys and girls. Neemoo moved here and there on the last step of the bus. After walking around a few circles, Neemoo decided to rest at the corner of the step. Neemoo lived in the corner of the dining room at Joe’s house. He has never gone out of the dining room. Even if he goes out to the window sill, some ants always came along. This is the first time Neemoo is away from the home and traveling on the bus.
          After the children went to school, someone started to clean the bus. Neemoo did not know what to do. He moved into the interior corner of the step and stayed there without moving a leg.`
      }
    }
  ]
};
