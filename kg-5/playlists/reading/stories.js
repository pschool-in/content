  ...
  list: [
    {
      ...
      data: {
        ...
        text: `One hot day, a thirsty crow flew all over the fields, looking for water. For a long time, he could not find anything. He felt very weak, almost lost all hope. Suddenly, he saw a water jug below the tree. He flew straight down to see if there was any water inside. Yes, he could see some water inside the jug!
...
The crow thought hard for a while. Then, he saw some pebbles around the pot. He had an idea. He started picking up the pebbles one by one, dropping each one of them into the jug. As a result, the water level rose. Soon it was high enough for the crow to drink. His plan had worked! The crow drank the water happily and flew in the sky, singing his favorite song.`,
        moral: 'Moral: Think smart, you may find a solution to problems.'
      }
    },
    {
      id: '200',
      ...
      data: {
        ...
        questions: [
          {
            qText: 'The crow was searching for water on a _____.',
            options: 'hot day, cold day, rainy day'
          },
          {
            qText: 'While searching for water, the crow found a _______.',
            options: 'water jug, water bottle, coke'
          },
          {
            qText: 'The neck of the jug was ______________.',
            options: 'very narrow, very wide, very dirty'
          },
          {
            qText: 'What happened when the pebbles were dropped into the jug?',
            options:
              'the water level in the jug increased, the jug broke, nothing happened'
          },
          {
            qText: 'Was the crow happy, at the end of the story?',
            options: 'yes, no'
          },
          {
            qText: 'What best defines the moral of the story?',
            options: `If we use our brain and think, we can find a solution to our problem.
...
One day, while cutting a tree near a river, his axe slipped, and fell into the river. The river was so deep, he could not take it out. That was the only axe he had. He started worrying. He will not be able to earn his living now! He was very sad and prayed to God. He prayed sincerely and God appeared in front of him and asked, “What is the problem, my son?” The woodcutter explained the problem and requested God to get his axe back.
The God stretched his hand deep into the river and took out a silver axe and asked, “Is this your axe?” The Woodcutter looked at the axe and said “No”. So, God put his hand back deep into the water again and took a golden axe and asked, “Is this your axe?” The woodcutter looked at the axe and said “No”. God said, “Take a look at it again Son, this is a very valuable golden axe. Are you sure, this is not yours?” The woodcutter said, “No, It’s not mine. I cannot cut trees with a golden axe. It’s not useful to me”.
The God smiled and finally put his hand into the water again and took out his iron axe and asked, “Is this your axe?” To this, the woodcutter said, “Yes! This is mine! Thank you!” God was very impressed with his honesty and gave him his iron axe, and also the other two axes as a reward for his honesty.`
      }
    },
    {
      id: '500',
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Where does the woodcutter go to cut the trees?',
            options: `To the forest, To the village, To his farm`
          },
          {
            qText:
              'The woodcutter was unable to take the axe from river because ___________.',
            options: 'the river was deep, the river was cold, the river was hot'
          },
          {
            qText: 'What kind of man is the woodcutter?',
            options:
              'Honest and sincere, Honest and lazy, Wicked and sincere, Jealous and honest'
          },
          {
            qText: 'Who came to help the woodcutter?',
            options: 'The God, A friend, A villager'
          },
          {
            qText: 'How many axes did the woodcutter get at the end?',
            options: 'Three, One, Two, Four'
          },
          {
            qText: 'Which of the following is the costly metal?',
...
While walking away, the fox said, “Had you been intelligent enough, you would never have jumped in without thinking how to get out.`,
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'The fox fell into a ______.',
            options: 'well, hole, river, pit'
          },
          {
            qText: 'Who came first and saw the fox next day?',
            options: 'A goat, A rat, A lion'
          },
          {
            qText:
              "Which of the following words represent the fox's character?",
            options: 'cunning, innocent, intelligent, helpful'
          },
          {
            qText: "What was the goat's mistake?",
            options: `It fell into the well without thinking.
It looked into the well.
It drank the water from the well.`
          },
          {
            qText: 'Why did the goat fall into the well?',
            options: `To drink water, To swim in the well, Just for fun, To help the fox`
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            options: 'In a forest, In a house, In a school'
          },
          {
            qText: 'The two friends met _________ on their way.',
            options: 'A bear, A thief, A lion'
          },
          {
            qText: "Why the other friend didn't climb the tree?",
            options: `He didn't know how to climb the tree.
He was very tired.
He was very lazy.
There is no place in the tree.`
          },
          {
            qText: 'The bear left the boy because ______.',
            options: `It thought the boy was dead.
It thought the boy was sleeping.
It was not hungry.`
          },
          {
            qText: 'What defines the moral of the story?',
            options: `True friends should support each other.
...
His life was going on smoothly with one golden egg a day, but now, he himself made his life miserable. Just because of his greediness, he became very poor.`,
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: "What is special about the merchant's hen?",
            options: `It laid golden eggs.
It laid eggs daily.
It wakes up early.`
          },
          {
            qText: 'What type of person is the merchant?',
            options: 'greedy, friendly, helpful, hardworking'
          },
          {
            qText: 'Why did the merchant kill the hen?',
            options: `He wanted to collect all the golden eggs.
He wanted to cook the hen.
The hen was making a lot of trouble.`
          },
          {
            qText: 'How the merchant felt at the end of the story?',
            options: 'Disappointed, Sad, Happy, Calm'
          },
          {
            qText: 'Which defines the moral of the story?',
            options: `One should not be greedy and be happy with what he is getting.
Never kill the hen that lays the golden egg.
Life is full of problems.`
    ...
    },
    {
      ...
      data: {
        title: 'Order the sentences based on the story.',
        text: `Merchant's hen laid a golden egg every day.
