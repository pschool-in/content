      ...
      data: {
        words: [
          ...
          },
          {
            word: 'cricket',
            marker: {x: 3, y: 6},
            hint: 'It is played with bat and ball, it is also the name of an insect',
            direction: 'across',
          },
          {
            word: 'boxing',
        ...
        words: [
          {
            word: 'spiderman',
            marker: {x: 0, y: 1},
            hint: 'He is a schoolboy by day, crime fighter by night, his powers come from an insect bite',
            direction: 'across',
          },
          {
            word: 'batman',
          ...
          },
          {
            word: 'Dory',
            marker: {x: 2, y: 2},
            hint: "I am Nemo's friend and have trouble remembering things. I am a blue fish",
            direction: 'across',
          },
        ],
        title: 'Solve the crossword. Please click on a cell to view the hint.',
