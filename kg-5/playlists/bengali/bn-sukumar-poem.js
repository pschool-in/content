...
চাঁদমুখে মিঠে গান ̰
  ...
  হাসির হাওয়া বন্ধ সেথায়,নিষেধ সেথায় হাসা ।`
    ...
    },
    {
      ...
      label: 'আড়ি',
      data: {
        title: 'আড়ি - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `কিসে কিসে ভাব নেই? ভক্ষক ও ভক্ষ্যে-
...
তোমাদের কারো কারো কেতাবের সহিতে ।`
    ...
    },
    {
      ...
      label: 'আনন্দ',
      data: {
        title: 'আনন্দ - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `যে আনন্দ ফুলের বাসে,
যে আনন্দ পাখির গানে,
যে আনন্দ অরুণ আলোয়,
...
যে আনন্দ তৃণের দলে,
যে আনন্দ আকাশ ভরা,
যে আনন্দ তারায় তারায়,
যে আনন্দ সকল সুখে,
যে আনন্দ রক্তধারায়
সে আনন্দ মধুর হয়ে
তোমার প্রাণে পড়ুক ঝরি,
সে আনন্দ আলোর মত
থাকুক তব জীবন ভরি।`
          }
        ]
    ...
    },
    {
      ...
      label: 'আজব খেলা',
      data: {
        title: 'আজব খেলা - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `সোনার মেঘে আল্‌তা ঢেলে সিঁদুর মেখে গায়
সকাল সাঁঝে সূর্যি মামা নিত্যি আসে যায় ।
নিত্যি খেলে রঙের খেলা আকাশ ভরে ভরে
আপন ছবি আপনি মুছে আঁকে নূতন করে।
...
উঠ্‌ছে জেগে- সেই কথা কি সুর্যিমামা জানে?`
    ...
    },
    {
      ...
      label: 'দাদা গো দাদা',
      data: {
        title: 'দাদা গো দাদা - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `দাদা গো দাদা, সত্যি তোমার সুরগুলো খুব খেলে!
...
গাইবে যদি ঐখেনে গাও, ঐ দিকে মুখ মেলে।`
    ...
    },
    {
      ...
      label: 'লোভী ছেলে',
      data: {
        title: 'লোভী ছেলে - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `কি ভেবে যে আপন মনে
...
তুলব বাড়ি মাথায় করে।`
    ...
    },
    {
      ...
      label: 'বড়াই',
      data: {
        title: 'বড়াই - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `গাছের গোড়ায় গর্ত করে ব্যাং বেঁধেছেন বাসা,
মনের সুখে গাল ফুলিয়ে গান ধরেছেন খাসা।
রাজার হাতি হাওদা-পিঠে হেলে দুলে আসে—
"বাপ্‌রে" বলে ব্যাং বাবাজি গর্তে ঢোকেন ত্রাসে!
রাজার হাতি মেজাজ ভারি হাজার রকম চাল;
হঠাৎ রেগে মটাৎ করে ভাঙল গাছের ডাল।
গাছের মাথায় চড়াই পাখি এবাক হয়ে কয়— 
"বাস্‌রে বাস্‌! হাতির গায়ে এমন জোরও হয়"!
মুখ বাড়িয়ে ব্যাং বলে, "ভাই, তাইত তোরে বলি— 
আমরা, অর্থাৎ চার-পেয়েরা, এম্নিভাবেই চলি"।`
          }
        ]
      }
    },
    {
      ...
      label: 'বাবু',
      data: {
        title: 'বাবু - সুকুমার রায়',
        text: [
          {
            type: 'poem',
            text: `অতি খাসা মিহি সূতি
ফিনফিনে জামা ধুতি,
