    ...
    },
    {
      ...
      data: {
        ...
        text: [
          {
            type: 'html',
            text: `<b>Predator</b>: An animal that hunts and feeds on other animals.<br><br>
<b>Efficiency</b>: The ability to accomplish something with the least amount of wasted time, effort, or resources.<br><br>
<b>Agile</b>: Quick and nimble in movement.<br><br>
<b>Precision</b>: The quality of being accurate and exact.<br><br>
<b>Jaw</b>: The mouth or oral cavity of an animal, especially one with sharp teeth.<br><br>
<b>Flesh</b>: The soft muscular tissue of an animal or human body.<br><br>
<b>Bone</b>: The hard, rigid connective tissue that forms the skeleton of vertebrates.`
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        text: [
          {
            type: 'html',
            text: `<b>Slithery</b>: Moving smoothly and sinuously, like a snake.<br><br>
<b>Glide</b>: Moved effortlessly and smoothly.<br><br>
<b>Foliage</b>: The leaves and branches of plants.<br><br>
<b>Camouflage</b>: Blended or disguised to match the surroundings for concealment.<br><br>
<b>Constricting</b>: Tightening or squeezing tightly.<br><br>
<b>Embrace</b>: A tight hold or grip.<br><br>
<b>Stealth</b>: The act of moving quietly and secretly to avoid detection.<br><br>
<b>Strategy</b>: A plan of action designed to achieve a specific goal.<br><br>
<b>Rodent</b>: A small mammal belonging to the order Rodentia, such as mice, rats, or squirrels.<br><br>
<b>Serpentine</b>: Resembling or characteristic of a serpent, or snake-like.`
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        text: [
          {
            type: 'html',
            text: `<b>Buildings</b>: Man-made structures where monkeys can be found perching or climbing on.<br><br>
<b>Tree</b>: Tall plants with a trunk and branches where monkeys often reside.<br><br>
<b>Peel</b>: The outer covering or skin of a banana that monkeys remove before eating.<br><br>
<b>Ancestor</b>: Referring to the theory of evolution, monkeys are considered to be distant relatives or predecessors of humans.`
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        text: [
          {
            type: 'html',
            text: `<b>Endangered</b>: Animals that are at risk of becoming extinct.<br><br>
    ...
    },
    {
      ...
      data: {
        ...
        text: [
          {
            type: 'html',
            text: `<b>Colony</b>: A group of animals or birds living together.<br><br>
<b>Slender</b>: Thin or slim in shape.<br><br>
<b>Vibrant</b>: Bright and intense in color.<br><br>
<b>Nest</b>: A structure built by birds to lay eggs and raise their young.<br><br>
<b>Algae</b>: Simple plants that grow in water or moist environments.`
          }
        ]
      }
    },
