  ...
  list: [
    {
      ...
      data: {
        ...
        text: `The sun, the moon, stars, and planets we see in the sky are called heavenly bodies. Some stars are brighter than others. It depends on their size and distance. Some planets are also visible to our eyes. Stars twinkle but planets don't.
All planets in the solar system revolve around the Sun. They also rotate about their own axis.
# Asteroids
...
It is also due to gravity that the moon revolves around the Earth. The moon is called a satellite of our Earth. Other planets also have their own moons. Mars has 2 moons, and Jupiter has 53 moons.
# Satellites
Heavenly bodies that move around the planets are called satellites. The moon is a natural satellite. Apart from that, many man-made satellites revolve around the Earth. They are sent to space with the help of rockets. These man-made satellites help us in telecommunication, predicting weather, and making maps.
# Do you know?
Space scientists have not yet been able to find a single other planet that has life on it. Therefore, our earth is an invaluable planet. The degradation of its environment for any reason will be a threat to the existence of life itself.`
      }
    },
    {
...
The time taken by the earth to complete one revolution around the sun is called a year. Actually, the earth takes 365 days and 6 hours to complete one revolution. 
# Leap Year
...
The period between two new moon days is 28-30 days.`
      }
    },
    {
      label: 'Fill up',
...
Revolution, Year`
    ...
    },
    {
      ...
      type: 'fillup',
      data: {
        title: 'Click on the blanks and fill in with the right word.',
...
Planets *revolve (rotate)* around a star, and they also *rotate (revolve)* around themselves.`
    ...
    },
    {
      ...
      data: {
        title: 'Solar System',
        text: `We can see numerous stars in a clear sky at night. The sun we see every day is also a star and it is the nearest star to the earth. The planets revolve around the sun at different distances in different orbits. This is called the solar system.
...
4. Mars is the fourth planet. It is red.
...
8. Neptune is the eighth planet. It is bluish-green and it is surrounded by clouds.
...
The first four planets that are nearer to the sun are called terrestrial planets. They are made of rock and metals. The last four planets that are far from the sun are called gaseous planets. They are mainly made of lighter gases like hydrogen and helium and a small molten rock core.`
    ...
    },
    {
      ...
      data: {
        title:
          'Sort the planets based on their distance from the sun. (Nearest planet at top)',
...
The heavenly bodies that look like stars but do not twinkle are planets.`
          },
          {
            name: 'False',
...
We should not watch the solar eclipse directly, as it may affect our eyes. The radiation during the solar eclipse is harmful to our eyes. 
There is no harm in watching the lunar eclipse.`
      }
    },
    {
      label: 'True or False',
...
We get a lunar eclipse when the moon comes between the sun and the Earth.
...
Earth is a gaseous planet.`
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Eclipse happens when three heavenly bodies _____.',
...
Solar Eclipse happens during the *day (night)*.
