...
We all depend on our surroundings for many things. We use the resources that we need and then discard the waste materials in the environment. This makes the environment dirty. The substances that make the environment dirty are called pollutants and the presence of these substances in the environment is called pollution.
# Air Pollution
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText:
              'Which of the following disease is caused due to regular drinking of polluted water?',
