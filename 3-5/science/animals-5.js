  ...
  list: [
    {
      ...
      data: {
        ...
        text: `Adaptation is the most essential factor of all living beings. The changes in an animal's behavior to adjust to its habitat are called adaptation. If an organism fails to adapt to a particular environment, its survival is difficult.
...
Changes in the physical features of the animal are called structural adaptations. For example, polar bears living in cold climates have physical adaptations, such as thick fur and short ears to reduce heat loss.
...
Changes in the activities of the animal are behavioral adaptations. Birds migrate to avoid adverse conditions.
...
Birds migrating is a *behavioral* adaptation.
...
*Birds* move from one place to another to avoid unfavorable climates.
...
feel even far away animals`
    ...
    },
    {
      ...
      data: {
        ...
        text: `Insects have three main body regions. They are the head, thorax and abdomen. All parts of the insect are inside an exoskeleton.
# Head
The main visible parts on the head are the large compound eyes, the antennae (feelers) and the mouthparts.
# Thorax
The thorax is the middle region of the body. It bears three pairs of legs and two pairs of wings.
# Abdomen
The abdomen is the last part of the insect body. The abdomen of most of the insects has clear segmentation.
...
Most of the insects have wings that can be folded flat over their body. Eg: bug
Some insects cannot fold their wings. Eg: dragonfly. Some insects are wingless. eg: ant, silverfish
...
Insects use the antennae to smell and feel the surface.`
    ...
    },
    {
      ...
      id: 'drag-drop-insect',
      data: {
        text: `Like any insect, butterfly has *three* body parts. It has *four* wings and *six* legs, attached to the *thorax*. It uses its two *antennae* to smell.`
      }
    },
    {
      label: 'True or False',
      ...
      data: {
        types: [
          {
            name: 'True',
            text: `The legs and wings are attached to the thorax.
...
Ants have a sense of sight, smell, taste and touch. Ants have organs of smell and taste in their antennae. They feel the vibrations in the ground through their feet.
Place a few sugar cubes on a plate. After some time, you can see some ants visiting the plate.
...
# Nocturnal animals
Some animals sleep in the daytime and are very active at night. A good example is a cat at your home. Such animals are called Nocturnal animals. Eg: owl, bat, mouse, firefly, moth 
Animals that are active during that time are known as diurnal animals. Eg: hen, horse, camel
Lions are active both during the day and night.
Nocturnal creatures generally have highly developed senses of hearing, smell, and specially adapted eyesight.`
    ...
    },
    {
      ...
      data: {
        questions: [
          {
            qText: 'Bats have a good sense of _______.',
...
To feel the vibrations in the ground`
          ...
          {
            qText: 'Which animal produces ultrasonic sound?',
...
Parental care increases the survival rate and improves the quality of young ones. It also increases the reproductive success of animals.
# Kangaroo
...
# Cow
The cow gives milk and protects its calf from the enemies. Mother and calf communicate with each other through sound. Calves respond to the calls from their own mother by calling back.
# Human beings
Humans promote and support the physical, emotional, social and intellectual development of their children. The human infant or baby is completely helpless at birth. Mother takes good care of the baby by feeding them, helping them to sleep and making them comfortable with clothes etc. Through proper parenting, the child is taught whatever is needed to live successfully in society.`
      }
    }
  ]
};
