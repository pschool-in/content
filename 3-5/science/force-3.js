...
When two objects touch each other, a special type of force develops between them. This special force is called friction. Friction slows down movements. When friction is very low, things move easily. When friction is more, it becomes difficult to move things. A wet floor is slippery because there is very little friction. Friction makes it possible for you to write. You cannot hold a pencil in your hand without friction. It would slip out of your hands. The pencil cannot make a mark on the paper without friction.`
      }
    },
    {
      label: 'Fill Up',
...
Friction slows down *movements*. A wet floor is slippery because there is very little *friction*.`
    ...
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'Push',
            text: 'kicking a ball, switching on a light, pedaling cycle '
          },
          {
            name: 'Pull',
    ...
    },
    {
      ...
      data: {
        ...
        text: `At a broad level, a force can be classified into contact and non-contact forces.
# Contact Force
...
We use our legs to pedal our bicycles. We use our hands to make some models from clay.
# Mechanical Force
The force applied by a machine is called mechanical force.
Eg: Using bulldozers to dig the ground. Grinding using a mixer grinder.
# Gravitational Force
...
# Frictional Force
When we roll down a ball on grass ground, it slows down and finally stops. We know that an object cannot stop without force. The force that stops the ball is frictional force. The force exerted by the surface when an object moves over it is called Frictional force.
When we use an eraser on paper, the shape of the eraser changes. It is because of the friction between the eraser and the paper.
...
If you put your palms together and rub them against each other. You can feel the heat on your palm.`
      }
    },
    {
      label: ' MCQ - 2',
...
A magnet attracts things that are made up of iron and plastic.`
          }
        ]
      }
    },
