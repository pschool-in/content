  ...
  list: [
    {
      ...
      data: {
        title: 'Food Chain',
        text: [
          `Grass is food for deer and deer is food for tiger. Plants are food for grasshoppers and grasshoppers are food for bird. Studying the food chain helps us understand how living things are related with one another by the food they eat. 
    ...
    },
    {
      ...
      data: {
        ...
        text: [
          `Animals gain a lot of benefits from spending time together with other members of the same species. This is called group behaviour. Animals like elephant and lion live in groups. But some animals like tiger and bear, live in solitary (alone). 
            Group behaviour is also called social behaviour. Members of the group work together to find food, defend themselves and look after the young ones. For example,  all the fish in a school move together, following their leader in the front. The main purpose of group behaviour is to help animals survive in nature.
            # Bees
            ...
            # Social Nesting
            Different birds have different behaviours. Some social nesting birds do not build individual nests. All males work together and build a common nest in which hundreds of birds can be housed.
            # Elephants
            Elephant group is called herd or parade. For each group, there is a female head, which leads the group towards the availability of food, water and safety. The leader fights for their group. All animals in a group obey the command of their leader. Older animals teach manners and life skills to young ones.
            # Advantages of group behaviour
            1. It is easy to procure food. Lions hunt together and share the prey.
            2. It is helpful in taking care of young ones. Female elephant takes care of its calf.
            3. It helps to protect from predators. When an animal find a danger, it alerts the others in the group.
      ...
      data: {
        ...
        questions: [
          ...
          },
          {
            ...
            options:
              'one female leader, one male leader, two female leader, two male leader'
          },
          {
    ...
    },
    {
      ...
      data: [
        `Lions *hunt* together and share the *prey*.
          Bees *split* the work amoung them. There are a few male bees called *drones* and hundreds of female bees called *workers*.
          The main purpose of group behaviour is to help animals *survive* in *nature*.`,
        `Animals that live alone are called *solitary* animals.
          ...
          When an animal find a *danger*, it *alerts* the other animals.`
      ]
    },
    {
      id: 'true-false',
      ...
      data: {
        types: [
          {
            name: 'True',
            text: `Different birds have different behaviours.
          ...
          },
          {
            ...
            text: `All animals like to live in groups.
              ...
              Animals that live in group are called solitary animals.`
          }
        ]
      }
    }
