...
EIt's important to *respect* other people's opinions and values, even if they differ from your own.`,
...
Leaving food out in the sun can cause it to *spoil* quickly, making it unsafe to eat.`
    ...
    },
    {
      ...
      label: 'Complete Word',
      data: [
        `A state of ill-being due to affliction or misfortune | Misery
Wetness caused by water | Moisture
...
Regard highly; think much of | Respect`,

        `Worthy of or requiring trust; held accountable | Responsible
Change to the contrary | Reverse
Cause to regain consciousness | Revive
A source of danger | Risk
Cause to separate and go in different directions | Scatter
A list of times at which things are planned to occur | Schedule
Responsive to physical stimuli | Sensitive
Any action or gesture that encodes a message | Signal
...
The loss of a loved one brought deep *woe* and sorrow to the grieving family.`
    ...
    },
    {
      ...
      label: 'Complete Word',
      data: [
        `Die of food deprivation | Starve
Be a guiding or motivating force or drive | Steer
Strenuous effort | Struggle
Meant or adapted for an occasion or use | Suitable
Determining opinions by interviewing people | Survey
Moving very fast | Swift
Something visible that represents something invisible | Symbol
Natural abilities or qualities | Talent
A belief that can guide behavior | Theory
Something that causes a sudden intense feeling | Thrill`,

        `Any possession that is highly valued by its owner | Treasure
A successful ending of a struggle or contest | Triumph
The quality that renders something desirable | Value
The ability to see | Vision
A person who performs work done by choice | Volunteer
Move or cause to move in a sinuous or circular course | Wander
Accumulated knowledge or erudition or enlightenment | Wisdom
Mental ability | Wit
