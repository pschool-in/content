...
?^hours 20 ^minutes = 200 ^minutes, 3`
    ...
    },
    {
      ...
      data: {
        ...
        type: 'word-problem',
        text: `The train left the terminal at 11:20 a.m. and arrived at its destination at 2:40 p.m. How long did the train travel? | ?0 hours ?1 minutes | 3, 20
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText:
              'It takes John 25 minutes to go to school and it takes Ashok 50 minutes to go to school. Today, John left home at 8:30 a.m. and Ashok left home at 8:15 a.m. Who arrived at school earlier?',
            options: 'John, Ashok, Both will reach at the same time'
          },
          {
            qText:
              'Sheela has a homework to write 5 pages. She takes 5 minutes to complete one page. Her little brother Ravi has a homework to write 2 pages. He takes 10 minutes to complete one page. Who will take more time to complete the homework.',
            options: 'Sheela, Ravi, Both will take same time'
          },
          {
            qText:
              '2-hour movie started at 10:30 am. By what time the movie gets over?',
            options: '12:30 pm, 12:30 am, 12:00 am, 12:00 pm'
          },
          {
            qText:
              'The doctor takes 5 minutes for each patient. I am the sixth patient in the queue. If the doctor arrives after 15 minutes, how much time do I have to wait to see the doctor?',
