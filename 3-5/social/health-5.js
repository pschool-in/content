  ...
  list: [
    {
      ...
      data: {
        ...
        text: `One has to take care to stay away from people who are ill with the flu (influenza), cold, ringworm, scabies, chickenpox. These diseases spread from one person to the other. Such diseases are called infectious diseases.
...
Some diseases spread through water. If another person drinks water that has been contaminated by these germs, they enter his intestines too, and that person can get the disease. To prevent the spread of disease in this manner, it is best to avoid washing clothes and bathing in the water sources or defecating on the banks of the water.
# Spread of disease through food
Several people get diarrhea after consuming contaminated food. Diseases spread through food also. This is also called food poisoning. Flies and other small insects transport the disease causing germs. That is why it is important to always keep our food covered. Food is handled while preparing or serving it.    
# The spread of disease by insects
Malaria is spread by the bite of a certain kind of mosquito. Insects like mosquitoes, lice and fleas spread disease.
...
If the water of a common source is contaminated by germs of a disease like cholera, then there is the danger of all those who drink that water getting the disease. If at someplace, mosquitoes breed in large numbers then many people there can get malaria. When many people in one area get the same infectious disease all at the same time, we say that there is an epidemic of the disease.
# Prevention of infectious diseases
1. To prevent diseases from spreading through water, we can use purified water. 
...
# Vaccination
When disease causing micro-organisms enter our body, the body resists the disease or fights the germs. That is why many times we do not get a disease even if germs enter our body.
Another way to prevent disease is vaccination. Our body develops resistance to a particular disease due to vaccination. Soon after a baby is born, she is given the tuberculosis vaccine. 
...
Primary Health Centres have been established at the village level. There are also facilities like mobile dispensaries, ambulances and a Welfare Fund for the disabled. Services like the examination of urine and blood, X-ray, ultra-sound and other scans are also available through the health programs. Thus, patients can get the service they need without delay. 
People are also educated about the right methods of handling drinking water and food. They are urged to maintain cleanliness in their surroundings. It is now forbidden by law to spit in a public place. The purpose of this ban is to prevent the spread of diseases. Mass media are also used for raising public awareness about health and hygiene issues.`
    ...
    },
    {
      ...
      data: {
        ...
        text: `In smaller towns and villages, *bleaching powder (salt)* is added to water sources to kill the germs.
...
To prevent diseases from spreading through water, water is purified. 
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          ...
          {
            qText: 'By which means disease spread?',
...
flu, air`
    ...
    },
    {
      ...
      data: {
        ...
        text: `Nutritious food, personal hygiene, exercise and pursuit of hobbies lead to excellent health and good personal development. Just as we take care of our health, we must make efforts to ensure good health for all. Everyone in our society should be able to live a happy life that we wish for ourselves. 
...
# Tobacco Consumption
Names of tobacco products such as gutka, cigarettes, bidis, pan masala, etc. are often heard. We also see many people consuming tobacco in different ways. All these are harmful to our health. 
...
5. The constant presence of tobacco in the digestive organs can cause cancer in any of those organs.
...
2. Alcoholism causes diseases in the liver, kidney, intestines and urinary bladder.
3. The condition of the addict becomes pathetic, and the addict's family has to suffer with them.
...
Tobacco, drugs and alcohol produce a state of intoxication. Addiction to any of them eventually kills the person.
Some people lure others into smoking, drinking, or trying out drugs. On no account should we give in to their pressure.
If a person starts getting addicted to smoking or drinking or taking drugs, the help of counselors or doctors should be sought immediately to get rid of the habit.
One should eat regularly and take up sports and other hobbies. One should be firm in avoiding any addiction.`
    ...
    },
    {
      ...
      data: {
        title: 'Click the blanks and fill it with the right word.',
        text: `A healthy and wholesome life leads to *friendship (hatred)*.
The constant presence of tobacco in the digestive organs can lead to *cancer (ulcer)* .
...
Good community *health (wealth)* can be achieved through habits of hygiene.`
      }
    },
    {
      label: 'True or False',
      ...
      data: {
        ...
        types: [
          {
            name: 'True',
            text: `Alcoholism causes diseases in the liver, intestines and urinary bladder.
    ...
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'Good',
            text: `Avoid alcohol and tobacco.
