...
*His (He)* leather shoes need to be polished.
...
*It's (Its)* going to rain tomorrow.
My toy is not in *its* box. Where could it be?
*It's (Its)* time to give the dog its dinner.
*It's (Its)* a  good idea to put on your helmet when you ride your bike.
...
*Who's (Whose)* that man in the white shirt?
*Who's (Whose)* the prime minister of India?
*Whose (Who's)* keys are on the table?
...
*They're (There, Their)* all eating cake together.
...
*Where (Where')* was the farmer's cow?
...
*Can (Could)* you give this bag to your mother?`,
        options: "can, could",
      },
    },
    {
...
*Would (Will)* you like some more chocolate in your milk? 
...
*Much (Many)* time is required to take care of my pets. 
...
*Where (Where')* is my mother?" The little child asked.
...
*There (Their)* is a red boat sailing on the river.
Sonali and Mona are sisters. *Their* parents are doctors.
*There (Their)* is a good team of dedicated staff at Sarojini Hospital.`,
        options: "there, their",
      },
    },
    {
