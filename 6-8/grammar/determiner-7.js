export default {
  ...
  · interrogatives: <b>which</b>`
          ...
          {
            type: 'html',
            text: `2. The general determiners are <b>a</b>; <b>an</b>; <b>any</b>; <b>another</b>; <b>other</b>; <b>what</b>.`
          },
  ...
  => We can use a singular noun with the indefinite article 'a' or 'an'.`,
          {
            type: 'html',
            text: `<b>Examples</b>: A woman was lifted to safety by <b>a</b> helicopter.<br>
  <b>A</b> man climbing nearby saw the accident.`
          },
          ...
          {
            type: 'html',
            text: `<b>Examples</b>: It's very easy. <b>Any</b> child can do it.<br>
  ...
  There's <b>an</b> otter over there.<br>
  <b>The</b> beaches in Goa are beautiful.<br>
  I'll give you <b>an</b> example of <b>the</b> essay question.`
          },
          ...
          {
            type: 'html',
            text: `<b>Examples</b>: I like <b>this</b> kind of biscuit.<br>
  Why don't you buy <b>that</b> book instead of this one?<br>
  <b>Those</b> children outside are being too noisy for this time of night.<br>
  I'll take <b>these</b> pills for my backache later.`
          },
          ...
          {
            type: 'html',
            text: `<b>Examples</b>: Do you like <b>my</b> new dress?<br>
  I prefer <b>my</b> uniform to <b>yours<b>.<br>
  Take <b>your</b> phone out of <b>your</b> pocket.`
          },
          `4. Quantifiers: Quantifiers provide approximate or specific answers to the questions "How many?" and "How much?"`,
          {
            type: 'html',
            text: `<b>Examples</b>: I only take <b>a little</b> bit of milk with my tea.<br>
  Quite <b>a few</b> people should be coming to the party.<br>
  I didn't take <b>many</b> holidays last year.<br>
  I haven't brought <b>much</b> money with me.<br>
  Do you think <b>a lot of</b> people believe what he says?<br>
  <b>Most</b> students work hard to pass their exams.<br>
  Have you got <b>any</b> proof that he committed the crime?<br>
  It takes <b>some</b> effort for me to do exercise.<br>
  Do we have <b>enough</b> rice to last the week?`
          },
          ...
          {
            type: 'html',
            text: `<b>Examples</b>: <b>Two</b> cars are enough for most families.<br>
  There are about <b>twenty-five</b> people in my office.<br>
  It's my <b>fortieth</b> birthday next week.<br>
  That is the <b>second</b> time you've done that!`
          },
          ...
          {
            type: 'html',
            text: `<b>Examples</b>: <b>Both</b> countries need to discuss the issues and find a solution.<br>
  <b>All</b> pet dogs need plenty of attention.<br>
  <b>Half</b> the people decided not to vote.<br>
  <b>Neither</b> house is suitable for our needs.<br>
  We can eat at <b>either</b> 7 pm or 8 pm.`
          },
          ...
          {
            type: 'html',
            text: `<b>Examples</b>: <b>Which</b> restaurant did you like best?<br>
  <b>What</b> time will you come?<br>
  <b>Whose</b> pencil is this?`
          },
          `# Rules
  ...
  *Those* cupcakes over there look delicious, I think I'll have one.`,
  ...
  Neha is in Assam. I ran into *her* cousin at the market yesterday and he told me.
  Who is that young woman? She is *your* assistant, I presume.`,
  ...
  *Some* of the students in the class were confused.`,
        ...
        `*Every* morning, I drink coffee for breakfast.
