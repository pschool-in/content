...
In our daily life we use a lot of water for many activities. We need water for drinking, brushing, bathing, washing utensils, washing clothes, cleaning floors etc. Water is used in industries for producing almost all the things that we use. So, we need water not only for our daily activities but also for producing many things. Water is an essential part of our life so it is important to use water carefully and conserve water.
...
At sufficient heights, the air becomes so cool that the water vapour present in it condenses to form tiny drops of water called droplets. It is these tiny droplets that remain floating in air and appear to us as clouds. Many drops of water join together to form large drops of water. Some drops of water become so heavy that they begin to fall to form rain.
...
`,
    ...
    },
    {
      ...
      data: {
        ...
        text: `The process of changing of water into its vapour is called *evaporation*.
...
The amount of usable water on earth is *limited (unlimited)* so it needs to be used carefully.`
    ...
    },
    {
      ...
      type: 'sorting',
      data: {
        title: 'Arrange the processes occuring in water cycle in correct order',
    ...
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'True',
            text: ` The process of water changing into its vapour is called evaporation.
