...
# A ray of light
A ray of light is an idealisation. In reality, we have a narrow beam of light which is made up of several rays. For  simplicity, we use the term ray for a narrow beam of light.
...
# Multiple Reflection
Multiple reflection is possible with the help of two or more mirrors. We could have witnessed this in a hair dresser shop.
...
Sometimes, particularly in old age, eyesight becomes foggy. When it happens, persons are said to have cataract. There is a loss of vision, sometimes extremely severe. It is possible to treat this defect. The opaque lens is removed and a new artificial lens is inserted. Modern technology has made this procedure simpler and safer. 
# Eye Care
Too little light or too much light is bad for eyes. Insufficient light causes eyestrain and headaches. Too much light, like Sun or powerful lamp can injure the retina. Never rub your eyes hard. If particles of dust go into your eyes, wash with clean water. Always read at the normal distance (25 cm).
# Do you know?
...
Owl can see well in the night but not during the day. It has a large cornea and a large pupil to allow more light. Also, its retina has large number of rods and only a few cones.
On the other hand, birds like eagle can see well during the day but not in the night. They have more cones and fewer rods in the retina.`
      }
    },
    {
      id: 'drag-drop-image',
    ...
    },
    {
      ...
      data: {
        ...
        types: [
          {
            name: 'True',
            text: `Too much of light is bad for eyes.
    ...
    },
    {
      ...
      data: {
        questions: [
          ...
          {
            qText: 'Which focuses the light falling on our eyes to retina?',
...
Can't see distant objects`
          },
          {
            ...
            options: `absense of sensory cells
eyelids
lack of light`
          }
        ]
