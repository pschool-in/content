  ...
  list: [
    {
      ...
      data: {
        title: 'Speed',
        text: `We are familiar with the term 'speed'. It is used to tell whether an object is moving fast or slow. Higher speed means more distance is covered in short duration. If you have a running race with your friend, the distance between the starting and ending points will be fixed. Whoever covers the distance in the short duration is the winner. If you both start at the same time then whoever crosses the finishing line first is the winner.
A car moves faster than a cycle. And a cycle can move faster than a walking man. A dog can move faster than a tortoise.
When we say that a car is moving at a speed of 50 kilometers per hour, it implies that it will cover a distance of 50 kilometers in one hour. A car cannot move at a constant speed. While starting, it will move slowly and gradually pick up speed. If you apply break gently it won't come to a halt immediately. Instead, its speed will reduce gradually. So we shall use the term average speed.
...
50, 20, 75, 30, 800, 600`
    ...
    },
    {
      ...
      data: {
        ...
        text: [
          `Time can be measured in seconds, minutes, hours, days, weeks, months, years, decades, century.
Time can be denoted as an absolute point of reference or interval. Clock and calendar show absolute time. A stopwatch, count-down timer, sand clock shows time interval.
# Working of a clock
...
Vehicles have a device to measure the distance moved by the vehicle. It is called an odometer. There is another device to measure the speed of the vehicle. It is called a speedometer.
# Distance-Time Graph
...
The distance traveled by a vehicle is measured by an *odometer* and the speed is measured by *speedometer*.
...
All cars move at the same speed.`
    ...
    },
    {
      ...
      id: 'complete-word',
      data: {
        text: `The device to measure the distance traveled. | ODOMETER | ___M____
In the olden days, most of the clocks work with the help of a _____. | PENDULUM | _______M
The metallic ball of a pendulum is called ___. | BOB | ___
The motion of a pendulum is an example of ______ motion. | PERIODIC | _______C
...
the travel time remains the same.`
          },
          {
            ...
            options: 'sundial, stopwatch, sand clock'
          },
          {
            qText: 'The working of a clock makes use of some _______ motion.',
...
Time Period of a pendulum`
          },
          {
            ...
            options: 'bicycle, motorcycle, car, lorry'
          }
        ]
      }
    }
