...
For transport through water routes, boats were used from ancient times. To begin with, boats were simple logs of wood in which a hollow cavity could be made. Later, people learned to put together different pieces of wood and give shapes to the boats. 
The invention of the wheel made a great change in modes of transport. The design of the wheel was improved over thousands of years. Animals were used to pull carts that moved on wheels.
Until the beginning of the 19th century, people still depended on animals, boats and ships to transport them from place to place. The invention of the steam engine led to the development of new means of transport. Railroads were made for steam engine-driven carriages and wagons. 
Later came automobiles such as motor cars, trucks and buses. Motorized boats and ships were used as means of transport on water. The early years of 1900 saw the development of airplanes. These were later improved to carry passengers and goods. Electric trains, monorails, supersonic airplanes and spacecraft are some of the contributions of the 20th century.`
      }
    },
    {
      label: 'Drag & Drop',
...
Supersonic airplanes travel at a speed larger than the speed of *sound (light)*.
...
These airplanes travel faster than sound. | SUPERSONIC | S____S____
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          ...
          {
            qText: 'How fast a vehicle move is defined by its ______.',
...
Measuring length is about the distance between two points or places. The two places may be close enough, like the two ends of a table or they may be far apart, like Jammu and Kanyakumari.
In ancient times, the length of a foot, the width of a finger, and the distance of a step were commonly used as different units of measurement. Even today, we can see flower sellers using their forearms as a unit of length for garlands in many towns in India. Unfortunately, all these measurements vary from person to person.
For the sake of uniformity, scientists all over the world have accepted a set of standard units of measurement. The system of units now used is known as the International System of Units (SI units). The SI unit of length is a meter.
Each meter (m) is divided into 100 equal divisions, called centimeters (cm). Each centimeter has ten equal divisions, called millimeter (mm). For measuring large distances, we use kilometers (km), which is 1000 times the meter. Measuring the length of a curved line cannot be done using a scale.
...
they are easy measurement`
          ...
          {
            qText: 'Which of the following is used to measure length?',
