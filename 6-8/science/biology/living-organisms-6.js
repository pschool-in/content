export default {
    ...
    list: [
      ...
      },
      {
        ...
        data: {
          title: 'Classify if the given features are characteristics of a living organism.',
          types: [
            {
              name: 'Yes',
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            ...
            {
                qText: 'When plastic enters a sewer system what damage can it cause?',
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'Classify the characters given as adaptations of mountain or desert plants and animals.',
          types: [
            {
              name: 'Mountain',
