export default {
    ...
    list: [
      ...
      },
      {
        ...
        type: 'classifySentence',
        data: {
          title: 'Classify the given materials  based on if they float or sink in water.',
          types: [
            {
              name: 'Float',
              text: `Rubber
      ...
      },
      {
        ...
        data: {
          ...
          questions: [
            ...
            {
                qText: 'Which of the following material is not  normally used in making of a pen?',
                options: `Wood, Plastic, Metal`
              },
              {
                qText: 'Which of the following is the most suitable material for making a chair?',
