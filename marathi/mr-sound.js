  ...
  list: [
    ...
    },
    {
      ...
      data: [
        ...
        { words: 'crab,snake,bull,tortoise,rat,ant,bat', audioOffset: 40 },
        { words: 'buffalo,butterfly,bee,goldfish,spider', audioOffset: 54 }
      ]
    },
    {
      type: 'rightOne',
      ...
      data: [
        {
          words: 'crow,dove,duck,hen,parrot,peacock,sparrow,eagle',
          audioOffset: 0
        },
        { words: 'ostrich,owl,rooster,vulture,woodpecker', audioOffset: 16 }
      ]
    }
  ]
};
