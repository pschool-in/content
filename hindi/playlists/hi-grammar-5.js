    ...
    list: [
      ...
      },
     {
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही द्रव्यवाचक संज्ञा चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
          text: `मेरे पास *सोने* के आभूषण हैं।
          एक किलो *तेल* लेकर आओ।
          मुझे *दाल* पसंद है।
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही समुदायवाचक संज्ञा चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही निश्चयवाचक सर्वनाम चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही अनिश्चयवाचक सर्वनाम या प्रश्नवाचक सर्वनाम चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही सम्बन्धवाचक सर्वनाम चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही परिमाणवाचक विशेषण चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
      ...
      },
      {
        ...
        data: {
            ...
            questions: [
              ...
              {
                qText: 'जब  एक  ही वाक्य के में जब एक से अधिक उपवाक्य , शब्द या वाक्यांश समान रूप से होते है तो किस विराम चिन्ह का उपयोग किया जाता है ? ',
                options: 'अल्प विराम, पूर्ण विराम, अर्द्ध विराम '
              },
              {
                qText: 'प्रश्नवाचक तथा विस्मयादिबोधक को छोड़कर सभी वाक्यों के अन्त में प्रयुक्त होता है– ',
              ...
              {
                qText: 'निम्नलिखित वाक्य में से सही विराम चिन्ह युक्त वाक्य को चुनिए|',
                options: 'अरे! तुम इतनी जल्दी उठ गए, अरे; तुम इतनी जल्दी उठ गए, अरे, तुम इतनी जल्दी उठ गए'
              }
            ]
        }
      },
      ...
      data: [
        {
          questions: [
            {
              qText: 'शारीरिक आरोज्ञ के लिए प्रात : एवं संध्याकालीन भ्रमण अन्यन्त लाभप्रद माना गया है',
              options:
                'आरोग्य, अरोग्य, आरोग'
            },
            {
...

        {
          questions: [
            ...
            {
              qText: 'मनुष्य जिसको सामान्य समझता है उसकी सेवा में उसे आनंद प्राप्त करता है',
              options:
                'सम्मान्य, समान्य, सम्मान्य'
            },
            {
              qText: 'जहाँ आत्मीयता हो वहां विचार विनियन में उपचारिकता नहीं होती',
              options:
        ...
        data: [
            ...
            questions: [
              {
                ...
                options: 'शब्द के आदि (आरंभ) में, शब्द के मध्य में, शब्द के अंत में'
              },
              {
                qText: 'जो धातु या शब्द के अंत में जोड़ा जाता है, उसे क्या कहते हैं?',
                options:
  ...
  
          {
            questions: [
              ...
              {
                qText: '‘अनुज’ शब्द को स्त्रीवाचक बनाने के लिए आप किस प्रत्यय का प्रयोग करेंगे? ',
                options:
                  'आ,  ईय,  ई '
              },
              {
                qText: 'सुत शब्द को स्त्रीवाचक बनाने के लिए किस प्रत्यय का प्रयोग किया जाएगा? ',
                options: 'आ,  ईय, इक'
              },
              {
  ...
  
          {
              questions: [
                ...
                {
                  qText: 'कौन-सा उपसर्ग ‘आचार’ शब्द से पूर्व लगने पर उसका अर्थ ‘जुल्म’ हो जाता है ? ',
                  options:
                    'अति, निर्, अन्'
                },
                {
  ...
  
            {
              questions: [
                {
                  qText: '‘व्यवस्था’ से पूर्व कौन-सा उपसर्ग लगायें कि उसका अर्थ विपरीत हो जाए ? ',
                  options: 'अ, आ,  अप'
                },
                {
