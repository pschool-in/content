export default {
    ...
    list: [
      ...
      },
      {
        ...
        data: {
            title: 'नीचे दिए गए विकल्पों में से सही उत्तर चुनिए।',
            text: `मैं एक आम आदमी हूँ। इस वाक्य मैं आम का अर्थ हैं - *साधारण (फल)*
      ...
      },
      {
        ...
        data: [
          [
            `मैं, मेरा, मेरे, मेरी, मुझे, मुझको `,
            `स्वयं, अपने आप, मेरा, मेरी`
          ],
          [` तेरे, तेरी, तुम, तुम्हे, तुमको, तुम्हारा `, `स्वयं, अपने आप, मेरा, मेरी`]
        ]
      },
      {
      ...
      },
      {
        ...
        data: {
          isPractice: false,
          title: 'दिए गए शब्दों में से सही संख्यावाचक विशेषण या परिमाणवाचक विशेषण चुनकर वाक्य पूरी करो।',
          styles: {
            fontSize: '1.3rem',
            dashWidth: 80
          },
      ...
      },
      {
        ...
        data: {
              isPractice: false,
              title: 'दिए गए शब्दों में से सही संकेतवाचक विशेषण चुनकर वाक्य पूरी करो।',
              styles: {
                fontSize: '1.3rem',
                dashWidth: 80
              },
