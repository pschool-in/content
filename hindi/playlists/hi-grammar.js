...
पावन, पौ + अन`
...

  {
    ...
    data: [
      ...
      [`लतियाना, दुखाना, थपथपाना, बड़बड़ाना, रुको`,`यहां, हमेशा, सचमुच, अवश्य, यहां-वहां`],
    ...
    data: [
      ...
      },
      {
        questions: [
          ...
          {
            qText: 'मै आधी रात को घर पंहुचा ',
            options: 'भूतकाल, भविष्य काल, वर्तमान काल'
          },
          {
            qText: 'मै खाना पकाऊँगा',
            options: 'भविष्य काल, भूतकाल, वर्तमान काल'
          },
          {
            qText: 'मैं बहुत सपने देखता हूं',
            options:
              'वर्तमान काल, भूतकाल , भविष्य काल'
          },
          {
      ...
      },
      {
        questions: [
          {
            qText: 'मैं हर रात खाना बनाती हूं ',
            options: 'वर्तमान काल, भूतकाल , भविष्य काल'
          },
          {
          ...
          {
            qText: `मैं अकेले यात्रा करता हूं`,
            options:
              'वर्तमान काल, भूतकाल , भविष्य काल'
          },
          {
            qText: `मै मंदिर जाता था `,
            options:
              'भूतकाल, भविष्य काल, वर्तमान काल'
          },
          {
      ...
      },
      {
        questions: [
          ...
          {
            qText: `मै अगले महीने नया फ़ोन खरीदूंगा`,
            options:
              'भविष्य काल, भूतकाल, वर्तमान काल'
          },
          {
      ...
      },
      {
        questions: [
          {
            qText: 'वह प्रतिदिन सुबह दौड़ के लिए जाता हैं',
            options: 'वर्तमान काल, भूतकाल , भविष्य काल'
          },
          {
            qText: 'मै कल बनारस गया था',
            options: 'भूतकाल, भविष्य काल, वर्तमान काल'
          },
          {
            qText: 'मै इस केस की जांच करूँगा ',
            options: 'भविष्य काल, भूतकाल, वर्तमान काल'
          },
          {
