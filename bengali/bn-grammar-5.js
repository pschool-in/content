  ...
  list: [
    {
      ...
      data: [
        // অ + অ = আ
        `নব + অন্ন = , নবান্ন , নবোন্ন 
সূর্য + অস্ত = , সূর্যাস্ত, সূর্যস্ত  
স্ব + অক্ষর = , স্বাক্ষর, স্বাক্ষার  
হিম + অচল = , হিমাচল, হিমচল  
চর + অচর  = , চরাচর, চারচর `,

        // অ + আ = আ
        `দেব + আলয় = , দেবালয়, দেবীলয়  
হিম + আলয় = , হিমালয়, হিমোলয় 
শরণ + আগত = , শরণাগত,  শরণগত
পদ + আঘাত = , পদাঘাত,  পদঘাত
ক্রম + আগত = , ক্রমাগত,  ক্রমোগত`,

        // আ + অ = আ
        `যথা + অর্থ = , যথার্থ, যতার্থ  
পূজা + অর্চনা = , পূজার্চনা,  পূজাচনা 
কথা + অমৃত = , কথামৃত,  কথমৃত
মহা + অরণ্য = , মহারণ্য,  মহরণ্য
মহা + অর্ঘ = , মহার্ঘ,  মহূর্ঘ`,

        // আ + আ = আ
        `মহা + আকাশ = , মহাকাশ, মহিকাশ  
কারা + আগার = , কারাগার, কারগার  
...
অতি + ইব =  , অতীব, অতব
অভি + ইষ্ট = , অভীষ্ট,  অভিষ্ট
প্রতি + ইতি = , প্রতীতি, প্রাপ্তীতি`,

        // ই+ঈ=ঈ , ঈ+ই =ঈ, ঈ+ঈ=ঈ
        `রথী + ইন্দ্র = , রথীন্দ্র,  রথিন্দ্র 
নারী + ঈশ্বর = , নারীশ্বর, নারেশ্বর  
পরি + ঈক্ষা = , পরীক্ষা,  পরিক্ষা
প্রতি + ঈক্ষা = , প্রতীক্ষা, প্রতিক্ষা
মহী + ঈশ্বর = , মহীশ্বর, মহেশ্বর`,

        // উ + উ = ঊ, উ + ঊ = ঊ, ঊ + উ = ঊ, ঊ + ঊ = ঊ

        `মরু + উদ্যান = , মরূদ্যান, মরুদ্যান  
কটু + উক্তি = , কটূক্তি, কুটূক্তি 
লঘু  + ঊর্মি = লঘূর্মি,  লঘুর্মি
বধূ + উক্তি = বধূক্তি, বধক্তি  
ভূ + ঊর্ধ্ব = , ভূর্ধ্ব, ভুর্ধ্ব`,
...
ছেলেটা সবকটা পুতুল *ভেঙে ফেলেছে*। `
    ...
    {
      id: 'bn-antonym-reading',
      type: 'passage',
      label: 'বিপরীতার্থক শব্দ',
      style: 'big',
      data: {
        title: 'বিপরীতার্থক শব্দ',
        text: `বিপরীতার্থক শব্দ যখন দুটি পদ পরস্পর বিপরীত অর্থ প্রকাশ করে তখন একটিকে অপরটির বিপরীতার্থক শব্দ বলে। যেমন-চেতন ও অচেতন।
মনে রাখতে হবে, বিপরীতার্থক শব্দ সর্বদাই সমপর্যায়ভুক্ত পদ হবে। অর্থাৎ একটি বিশেষ্য পদ হলে অপরটিও বিশেষ্য পদ হবে। একটি বিশেষণ হলে অপরটি বিশেষণ পদ হবে।
ক্রেতা–বিক্রেতা, কাপুরুষ—বীরপুরুষ, কাচা–পাক, হ্রাস-বৃদ্ধি, সত্য-মিথ্যা, সরল – জটিল কিছু উদাহরণ`
      }
    },
...
কাচা = , পাকা, পুরানো `
    ...
    {
      // class v and above
      id: 'compoundword-reading-2',
      type: 'passage',
      label: 'সমোচ্চারিত ভিন্নার্থক শব্দ',
      style: 'big',
      data: {
        title: 'সমোচ্চারিত ভিন্নার্থক শব্দ',
        text: `একাধিক শব্দের উচ্চারণ এক‌ই বা প্রায় এক‌ই হলেও তাদের অর্থ যদি আলাদা হয়, তখন ঐ শব্দগুলিকে বলা হয় সমোচ্চারিত ভিন্নার্থক শব্দ।
সব ভাষার মতো বাংলা ভাষাতেও এমন বহু শব্দ আছে যাদের উচ্চারণ পুরোপুরি এক বা প্রায় এক হলেও অর্থের পার্থক্য আছে। বেশিরভাগ ক্ষেত্রে এদের মধ্যে বানানে পার্থক্য থাকে কিন্তু অনেক ক্ষেত্রে বানানেও কোনো পার্থক্য থাকে না। বানানে পার্থক্য না থাকলে বাক্যে প্রয়োগ দেখে বুঝতে হয় শব্দটি কোন অর্থে ব্যবহৃত হয়েছে। এই শব্দগুলিকে ব্যাকরণের পরিভাষায় সমোচ্চারিত ভিন্নার্থক শব্দ বলে।
#কিছু উদাহরণ
1. পরা-পরিধান, পড়া-পড়াশুনা
2. নিত্য-প্রতিদিন, নৃত্য-নাচ 
3. মূর্খ-জ্ঞানহীন, মুখ্য-প্রধান
4. দিন-দিবস, দীন-দারিদ্র`
      }
    },
    {
