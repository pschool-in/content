  ...
  list: [
    {
      ...
      data: {
        ...
        text: [
          ...
          {
            type: 'sitewords',
            text: 'பலாப்பழம்,  மாம்பழம்,  வாழைப்பழம்,  கொய்யாப்பழம்,  திராட்சை,  ஆரஞ்சு,  பப்பாளி,  அன்னாசிப்பழம், ஆப்பிள்,  மாதுளை,  தர்பூசணி,  கரும்பு,  நெல்லிக்காய்,  எலுமிச்சம்,  சீதாப்பழம்,  பேரிச்சம்பழம்',
            width: 115
          },
          `# காய்கள்`,
          {
            type: 'sitewords',
            text: 'வெங்காயம்,  தக்காளி,  கத்திரி,  வாழைக்காய்,  பூண்டு,  இஞ்சி,  முள்ளங்கி,  பாகற்காய்,  வாழைப்பூ,  சுரைக்காய், காரட்,  பீட்ரூட்,  முட்டைகோசு,  உருளைக்கிழங்கு,  தேங்காய்,  வெண்டைக்காய்,  முருங்கைக்காய்,  புளி,  காளான்,  சேனைக்கிழங்கு, பச்சைமிளகாய்,  கருவேப்பிலை,  கொத்தமல்லி,  புதினா,  கீரை,  மஞ்சள்,  பரங்கிக்காய்,  பூசணிக்காய்',
            width: 115
          },
          `# உணவு`,
          {
            type: 'sitewords',
            text: ' உணவு,  பால்,  இட்லி,  தோசை,  பொங்கல்,  வடை,  புட்டு,  இடியாப்பம்,  புரோட்டா,  முட்டை, பாதாம்,  முந்திரி, அரிசி,  உப்பு,  மாவு,  நெல்,  கோதுமை,  மிளகு',
            width: 115
          }
        ]
      }
