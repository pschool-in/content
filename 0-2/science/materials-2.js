export default {
  ...
  list: [
      ...
      data: [
        {
          ...
          questions: [
            ...
            {
              qText: 'The major parts of a TV remote are made of _____.',
              qImg: 'remote',
        ...
        },
        {
          ...
          questions: [
            {
              qText: 'The below wheel is made of ______.',
              qImg: 'wheel',
              options: 'wood, metal, rubber, stone, plastic'
            },
            {
              qText: 'The below tap is made of ______.',
              qImg: 'tap',
              options: 'metal, rubber, stone, plastic, wood'
            },
            {
            ...
            {
              qText: 'The below dustbin is made of _____.',
              qImg: 'dustbin',
              options: 'plastic, wood, cotton, metal'
            },
            {
    ...
    },
    {
      ...
      data: {
        title: 'Materials',
        text: `We can see a lot of materials around us. They can be made of wood, plastic, metal, rubber etc.
By looking at it, and by touching it, we can easily guess the material.
# Wood
Wood is a material we get from trees. We make many things like chairs, toys, pencils, ladders, bats, matchsticks, doors, windows, bookshelves. 
# Clay
Clay is a type of soil. Clay is a natural material. It is sticky and can absorb water. When mixed with water, it becomes soft. It hardens as it dries; so, pots, bricks and other things can be made from it. A potter uses his tool to make clay pots.
# Glass
...
*Wood* is obtained from trees. It is used in making *pencils*.
Clay *absorbs* water, and becomes *soft*. It *hardens* when it is heated.`
      }
    },
    {
      label: 'Fiber - Notes',
      ...
      data: {
        title: 'Fiber',
        text: `Fibre is a material obtained from both plants and animals. Cotton and jute are the fibers obtained from plants. Wool and silk are fibers obtained from animals. Fibre from the coconut tree is called coir. Many things are made from it.
The jute fiber is long, shiny and strong. Silk is the strongest natural fiber. We make many things like bags, mats and sarees from these fibers. Wool keeps us warm; so sweaters, caps and socks are knitted using it. Leather is flexible; so belts, watch straps and bags are made from it.`
      }
    },
    {
      label: 'Fill in the blanks',
...
It is also used in making balls, tyres, erasers, and slippers.
# Elastic
It means the material comes back to its original shape after being stretched.
# Waterproof
It means it does not allow water to enter inside and it doesn't get wet or absorb water.`
      }
    },
    {
      label: 'Metals - Notes',
      ...
      data: {
        title: 'Metals',
        text: `Metals are materials obtained from metal ores that lie in the ground. eg: iron, copper, gold, silver.
Metals are strong and hard. It is used in making vehicles, gates, and cooking vessels. Metals are shiny.
When heated, metals can be shaped into any form - small paper clips or a huge airplane.`
      }
    },
    {
      id: 'match',
...
Clay becomes soft when mixed with water.`
          },
          {
            name: 'False',
...
Metals are elastic materials.`
    ...
    },
    {
      ...
      id: 'mixed-drag-drop',
      data: [
        `Meera is coloring with a *pencil*.
Grandfather is sitting in a *chair*.
