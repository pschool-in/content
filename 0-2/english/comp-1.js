  ...
  list: [
        ...
        questions: [
          {
            ...
            options: 'colorful, colorless, seven-legged'
          },
          {
    ...
    },
    {
      ...
      data: {
        title: 'Read the passage and answer the questions',
        type: 'passage',
        text: `Peacocks are beautiful birds with majestic wings. They are known worldwide for their beauty. They are our national bird. They are mostly seen in rainforests. The moon-like spots on Peacock's feathers make the shape of an eye when fully opened.`,
        image: 'peacock',
        fontSize: '1.3rem',
        questions: [
          {
            qText: 'What is the national bird of India?',
            options: 'Peacock, Sparrow, Eagle, Pigeon'
          },
          {
            qText: 'Where are peacocks mostly found?',
            options: 'rainforests, deserts, grasslands, arctic regions'
          },
          {
            qText: "What makes the peacock's feathers look like eyes?",
            options: 'moon-shaped spots, stripes, dots, zigzag patterns'
          },
          {
            qText: 'What makes peacocks known worldwide?',
            options:
              'Their majestic wings, Their long-distance flights, Their ability to mimic human speech'
          }
        ]
      }
    },
    {
      ...
      data: {
        title: 'Read the passage and answer the questions',
        type: 'passage',
        text: `An owl is a bird that hates the light. It can see well at night. They hunt at night. They eat insects and small birds. They are wise creatures.`,
        image: 'owl',
        fontSize: '1.3rem',
        questions: [
          {
            qText: 'What is the main characteristic of an owl?',
            options:
              "It hates the light, It loves the light, It can't see well in the dark, It has excellent hearing"
          },
          {
            qText: 'When do owls typically hunt?',
            options:
              'During the night, During the day, At dusk and dawn, Whenever they feel like it'
          },
          {
            qText: 'What is a common prey for owls?',
            options:
              'Insects and small birds, Plants and fruits,  Fish and amphibians, Small mammals'
          },
          {
            qText: 'How are owls often described?',
            options:
              'As intelligent or wise creatures, As clumsy and slow flyers, As solitary and aggressive animals, As brightly colored birds'
          }
        ]
      }
    },
