  ...
  list: [
    {
      ...
      data: {
        ...
        type: 'passage',
        text: `Cats are lazy animals. They have whiskers around their nose. They spend 70% of their lives sleeping. But they also spend a lot of time cleaning themselves and remaining tidy. Cats love eating fish and milk.`,
        image: 'cat',
        fontSize: '1.3rem',
        questions: [
          {
          ...
          {
            qText: 'What is the nature of a cat?',
            options: 'Lazy, Energetic, Irritated'
          }
        ]
      }
    },
    {
      ...
      data: {
        title: 'Read the passage and answer the questions',
        type: 'passage',
        text: `Dogs are wonderful pets and our loyal friends. They are domestic animals that bring joy to our lives. With their wagging tails and friendly nature, they always make us smile. Dogs have sharp teeth and live for about 10-13 years. They love to eat bones and playing 'fetch' is their favorite game.`,
        image: 'dog',
        fontSize: '1.3rem',
        questions: [
          {
          ...
          {
            qText: 'Dog live for about ______ years.',
            options: '10-13, 5-10, 2-5'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        title: 'Read the passage and answer the questions',
        type: 'passage',
        text: `Lion is a very powerful and strong animal. They look like very big cats with hair all around their face. Lions live together in caves or dens. Baby lions are called cubs. The sound of their roar can be heard 8kms away.`,
        image: 'lion',
        fontSize: '1.3rem',
        questions: [
          {
    ...
    },
    {
      ...
      data: {
        title: 'Read the passage and answer the questions',
        type: 'passage',
        text: `Tigers are the largest animals in the cat family. They have vertical strips over their body. They're usually orange, black and white. But some tigers are just white and black. Tiger babies are called cubs.`,
        image: 'tiger',
        fontSize: '1.3rem',
        questions: [
          {
          ...
          {
            qText: 'Which colors are commonly found on a tiger?',
            options: 'Orange and Black, Red and Brown, Blue and White'
          },
          {
            qText: 'Tigers are the ________ animals in the cat family. ',
            options: 'largest, smallest, moderate'
          }
        ]
      }
    },
    {
      ...
      data: {
        title: 'Read the passage and answer the questions',
        type: 'passage',
        text: `Rabbits love eating carrots and hay. They chew 120 times in a minute. It helps them to digest food easily. Rabbits live in burrows. They're also called bunnies. `,
        image: 'rabbit',
        fontSize: '1.3rem',
        questions: [
          {
