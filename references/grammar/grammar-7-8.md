...
Class-8 
1. Articles as Determiners - Give information about 'which' and 'how many/much'
2. Quantifiers - Expression of the quantity of the object
3. Determiner of number - Expression of the quantity of the object
4. Predeterminer, Central determiner and Post determiner - Order of Determiners
...
5. Modal Auxilaries - (can/could; may/must; shall/should; ought to/need to; will/would) Class-8 
...
2. Complement - (Function of complement, Subject complement and Object complement)
3. Kinds of Subordinate Clauses - (Noun clauses; Adjective clauses; Adverb clauses; Conditional clauses)
4. Relative Clauses - (non essential parts of sentence) 
5. Conditionals - (Clauses; Zero conditional; First conditional; Second conditional; Third conditional) 
6. Punctuation - (hyphen/dash)
...
Class-8 
1. Position of Adverbs - (position of adverb with respect to subject and verb)
2. Adverbials - (words or word groups that do the work of an adverb)
3. Clauses - Adverbials as clauses
4. Order of Adverbials - (adverbs of manner -> place -> frequency -> time -> purpose)
5. Adverbial Phrases - (a group of words that functions as an adverb)
...
2. Direct and Indirect Speech - (Interchanging reported speech) 
3. Idioms (Examples)
...
2. Homophones, homographs and homonyms - (Defenition and Examples)
